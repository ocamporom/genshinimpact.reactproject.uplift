...
function GenshinCharacterSearchFunctionality() {
  ...
  return (
    ...
    <div className={style.searchFieldContainer}>
      <input className={style.searchField} type="search" onChange={handleOnChange} value={artifactsName} />
      <button className={style.searchButton} onClick={handleOnClick}>Search</button>
    </div>
    </>
  );
}
